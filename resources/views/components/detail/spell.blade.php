...
<div class="flex flex-wrap sm:flex-nowrap gap-4 justify-between mt-2">
    ...
    <div class="w-full sm:w-2/3 flex flex-col gap-4">
        <div class="p-4 bg-white rounded-lg border border-2 border-gray-300 flex h-fit flex-col justify-between">
            <div>
    ...
    <div class="w-full sm:w-1/3 flex flex-col gap-4">
        <div class="flex flex-col gap-2 rounded-xl p-4 border border-2 border-gray-300 bg-white h-fit">
