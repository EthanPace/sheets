...
<li>
    @if ($enabled)
        <input type="radio" id="{{ $option_name }}" name="{{ $list_name }}" value="{{ $option_name }}" class="hidden peer"/>
    ...
    @else
        <input disabled type="radio" id="{{ $option_name }}" name="{{ $list_name }}" value="{{ $option_name }}" class="hidden peer" />
        <label for="{{ $option_name }}"
