<x-layout>
    ...
    <main class="p-2 sm:p-4 overflow-scroll content-center">
        <!-- Weapons -->
        <div class="max-w-[95rem] bg-white rounded-3xl border border-2 border-gray-500 mb-4 sm:mb-20 3xl:mt-12 mx-auto">
        ...
        <!-- Armor -->
        <div class="w-full max-w-[95rem] bg-white rounded-3xl border border-2 border-lime-500 mb-4 sm:mb-20 mx-auto">
            <table class="w-full text-left mb-6">
                <thead>
                    <tr class="text-left text-lg">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 sm:gap-20 justify-between w-full max-w-[95rem] mx-auto">
            ...
            <!-- Right-hand Column -->
            <div class="flex flex-col sm:gap-16">
                <!-- Spellcasting Focuses -->
                <div class="w-full max-w-[45rem] h-fit bg-white rounded-3xl border border-2 border-cyan-500 mb-4">
                    <table class="w-full text-left mb-6">
                        <thead>
                            <tr class="text-left text-lg">
                ...
                <!-- Equipment Packs -->
                <div class="w-full max-w-[45rem] h-fit bg-white rounded-3xl border border-2 border-rose-500 mb-4">
                    <table class="w-full text-left mb-6">
                        <thead>
                            <tr class="text-left text-lg">
                ...
                <!-- Tools -->
                <div class="w-full max-w-[45rem] h-fit bg-white rounded-3xl border border-2 border-purple-500 mb-4">
                    <table class="w-full text-left mb-6">
                        <thead>
                            <tr class="text-left text-lg">
                ...
                <!-- Food & Drink -->
                <div class="w-full max-w-[45rem] h-fit bg-white rounded-3xl border border-2 border-yellow-500 mb-4">
                    <table class="w-full text-left mb-6">
                        <thead>
                            <tr class="text-left text-lg">
