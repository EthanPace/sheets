<x-layout>
    ...
    <main class="p-4 overflow-scroll content-center">
        <!-- Weapons -->
        <div class="w-[95rem] bg-white rounded-3xl border border-2 border-indigo-500 mb-20 mt-12 mx-auto">
            <table class="w-full text-left mb-6">
                ...
                <tbody class="rounded-b-xl">
                    @foreach ($weapons as $weapon)
                        <tr class="odd:bg-indigo-100 pl-4">
        ...
        <!-- Armor -->
        <div class="w-[95rem] bg-white rounded-3xl border border-2 border-green-500 mb-20 mx-auto">
            <table class="w-full text-left mb-6">
                <thead>
                    <tr class="text-left text-lg">
                ...
                <tbody class="rounded-b-xl">
                    @foreach ($armors as $armor)
                        <tr class="odd:bg-green-100 pl-4">
