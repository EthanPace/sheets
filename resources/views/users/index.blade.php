<x-layout>
    ...
    <div class="p-4 w-full h-full overflow-y-scroll sm:flex sm:gap-4">
                ...
                <table class="w-full">
                    <thead>
                        <tr class="sm:text-xl">
                            ...
                            <th scope="col" class="p-4 text-center">Role</th>
                        ...
                        @foreach ($users as $user)
                            <tr class="odd:bg-gray-200 even:bg-white last:!bg-transparent">
                                ...
                                <td class="py-2 px-4 text-right">
                                    <x-post-button action="/users/{{ $user->id }}/password-reset" method="POST" padding="4" theme="rose">RESET</x-post-button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
