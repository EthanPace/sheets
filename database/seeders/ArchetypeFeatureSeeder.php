...
use App\Models\ArchetypeFeature;
use Illuminate\Database\Console\Seeds\WithoutModelEvents;
use Illuminate\Database\Seeder;

class ArchetypeFeatureSeeder extends Seeder
{
    /**
...
You can also expend 5 Hit Points from the pool of healing power to remove the Poisoned condition from the creature; those points don't also restore Hit Points to the creature.",
        ...
        ArchetypeFeature::factory()->create([
            ...
            'level' => 1,
            'name' => "Spellcasting",
            'description' => "You have learned to cast spells through prayer and meditation. See chapter 7 for the rules on spellcasting. The information below details how you use those rules with Paladin spells, which appear in the Paladin spell list later in the class's description.
...
Whenever you finish a Long Rest, you can change the kinds of weapons you chose. For example, you could switch to using the mastery properties of Halberds and Flails.",
        ...
        ArchetypeFeature::factory()->create([
            ...
            'level' => 2,
            'name' => "Fighting Style",
            'description' => "You gain a Fighting Style feat of your choice (see chapter 5 for feats). Instead of choosing one of those feats, you can choose the option below.
...
Divine Sense. As a Bonus Action, you can open your awareness to detect Celestials, Fiends, and Undead. For the next 10 minutes or until you have the Incapacitated condition, you know the location of any creature of those types within 60 feet of yourself, and you know its creature type. Within the same radius, you also detect the presence of any place or object that has been consecrated or desecrated, as with the Hallow spell.",
        ...
        ArchetypeFeature::factory()->create([
            ...
            'description' => "You gain a Paladin subclass of your choice. The Oath of Devotion, Oath of Glory, Oath of the Ancients, and Oath of Vengeance subclasses are detailed after this class's description. A subclass is a specialization that grants you features at certain Paladin levels. For the rest of your career, you gain each of your subclass's features that are of your Paladin level or lower.",
        ]);
        ArchetypeFeature::factory()->create([
            'archetype_id' => $paladin->id,
            'level' => 4,
            'name' => "Ability Score Improvement",
            'description' => "You gain the Ability Score Improvement feat (see chapter 5) or another feat of your choice for which you qualify. You gain this feature again at Paladin levels 8, 12, and 16.",
        ]);
        ArchetypeFeature::factory()->create([
            'archetype_id' => $paladin->id,
            'level' => 5,
...
If another Paladin is present, a creature can benefit from only one Aura of Protection at a time; the creature chooses which aura while in them.",
        ...
        ArchetypeFeature::factory()->create([
            ...
            'level' => 19,
            'name' => "Epic Boon",
            'description' => "You gain an Epic Boon feat (see chapter 5) or another feat of your choice for which you qualify. Boon of Truesight is recommended.",
        ]);
        //
        // Fighter
        //
        ...
        ArchetypeFeature::factory()->create([
            ...
            'level' => 1,
            'name' => "Fighting Style",
            'description' => "You have honed your martial prowess and gain a Fighting Style feat of your choice (see chapter 5). Defense is recommended. Whenever you gain a Fighter level, you can replace the feat you chose with a different Fighting Style feat.",
        ]);
        ArchetypeFeature::factory()->create([
            'archetype_id' => $fighter->id,
            'level' => 1,
        ...
        ArchetypeFeature::factory()->create([
            ...
            'level' => 4,
            'name' => "Ability Score Improvement",
            'description' => "You gain the Ability Score Improvement feat (see chapter 5) or another feat of your choice for which you qualify. You gain this feature again at Fighter levels 6, 8, 12, 14, and 16.",
        ]);
        ArchetypeFeature::factory()->create([
            'archetype_id' => $fighter->id,
            'level' => 5,
        ...
        ArchetypeFeature::factory()->create([
            ...
            'level' => 9,
            'name' => "Indomitable",
            'description' => "If you fail a saving throw, you can reroll it with a bonus equal to your Fighter level. You must use the new roll, and you can't use this feature again until you finish a Long Rest. You can use this feature twice before a Long Rest starting at level 15 and three times before a Long Rest starting at level 17.",
        ]);
        ArchetypeFeature::factory()->create([
            'archetype_id' => $fighter->id,
            'level' => 9,
        ...
        ArchetypeFeature::factory()->create([
            ...
            'level' => 19,
            'name' => "Epic Boon",
            'description' => "You gain an Epic Boon feat (see chapter 5) or another feat of your choice for which you qualify. Boon of Combat Prowess is recommended.",
        ]);
        ArchetypeFeature::factory()->create([
            'archetype_id' => $fighter->id,
            'level' => 20,
        ...
        ArchetypeFeature::factory()->create([
            ...
            'level' => 4,
            'name' => "Ability Score Improvement",
            'description' => "You gain the Ability Score Improvement feat (see chapter 5) or another feat of your choice for which you qualify. You gain this feature again at Barbarian levels 8, 12, and 16.",
        ]);
        ArchetypeFeature::factory()->create([
            'archetype_id' => $barbarian->id,
            'level' => 5,
        ...
        **At Higher Levels.** Your Bardic Inspiration die changes when you reach certain Bard levels, as shown in the Bardic Die column of the Bard Features table. The die becomes a d8 at level 5, a d10 at level 10, and a d12 at level 15.",
        ...
        ArchetypeFeature::factory()->create([
            ...
            'level' => 1,
            'name' => "Spellcasting",
            'description' => "You have learned to cast spells through your bardic arts. See chapter 7 for the rules on spellcasting. The information below details how you use those rules with Bard spells, which appear in the Bard spell list later in the class's description.
        ...
        **Spellcasting Focus.** You can use a Musical Instrument as a Spellcasting Focus for your Bard spells.",
        ...
        ArchetypeFeature::factory()->create([
            ...
            'level' => 3,
            'name' => "Bard Subclass",
            'description' => "You gain a Bard subclass of your choice. The College of Dance, College of Glamour, College of Lore, and College of Valor subclasses are detailed after this class's description. A subclass is a specialization that grants you features at certain Bard levels. For the rest of your career, you gain each of your subclass's features that are of your Bard level or lower.",
        ]);
        ArchetypeFeature::factory()->create([
            'archetype_id' => $bard->id,
            'level' => 4,
            'name' => "Ability Score Improvement",
            'description' => "You gain the Ability Score Improvement feat (see chapter 5) or another feat of your choice for which you qualify. You gain this feature again at Bard levels 8, 12, and 16.",
        ]);
        ArchetypeFeature::factory()->create([
            'archetype_id' => $bard->id,
            'level' => 5,
        ...
        ArchetypeFeature::factory()->create([
            ...
            'level' => 19,
            'name' => "Epic Boon",
            'description' => "You gain an Epic Boon feat (see chapter 5) or another feat of your choice for which you qualify. Boon of Spell Recall is recommended.",
        ]);
        ArchetypeFeature::factory()->create([
            'archetype_id' => $bard->id,
            'level' => 20,
        ...
        ArchetypeFeature::factory()->create([
            ...
            'level' => 1,
            'name' => "Spellcasting",
            'description' => "You have learned to cast spells through prayer and meditation. See chapter 7 for the rules on spellcasting. The information below details how you use those rules with Cleric spells, which appear on the Cleric spell list later in the class's description.
        ...
        **Turn Undead.** As a Magic action, you present your Holy Symbol and censure Undead creatures. Each Undead of your choice within 30 feet of you must make a Wisdom saving throw. If the creature fails its save, it has the Frightened and Incapacitated conditions for 1 minute. For that duration, it tries to move as far from you as it can on its turns. This effect ends early on the creature if it takes any damage, if you have the Incapacitated condition, or if you die.",
        ...
        ArchetypeFeature::factory()->create([
            ...
            'level' => 4,
            'name' => "Ability Score Improvement",
            'description' => "You gain the Ability Score Improvement feat (see chapter 5) or another feat of your choice for which you qualify. You gain this feature again at Cleric levels 8, 12, and 16.",
        ]);
        ArchetypeFeature::factory()->create([
            'archetype_id' => $cleric->id,
            'level' => 5,
        ...
        **Potent Spellcasting.** When you cast a Cleric cantrip and deal damage to a creature with it, you can give vitality to yourself or another creature within 60 feet of yourself, granting a number of Temporary Hit Points equal to twice your Wisdom modifier.",
        ...
        ArchetypeFeature::factory()->create([
            ...
            'level' => 19,
            'name' => "Epic Boon",
            'description' => "You gain an Epic Boon feat (see chapter 5) or another feat of your choice for which you qualify. Boon of Fate is recommended.",
        ]);
        ArchetypeFeature::factory()->create([
            'archetype_id' => $cleric->id,
            'level' => 20,
        ...
        'level' => 1,
        'name' => "Spellcasting",
        'description' => "You have learned to channel the magical essence of nature to cast spells. See chapter 7 for the rules on spellcasting.
        ...
        **Rules While Shape-Shifted:** While in a form, you retain your personality, memories, and ability to speak, and the following rules apply:
        ...
        'level' => 3,
        'name' => "Druid Subclass",
        'description' => "You gain a Druid subclass of your choice. The Circle of the Land, Circle of the Moon, Circle of the Sea, and Circle of the Stars subclasses are detailed after this class's description. A subclass is a specialization that grants you features at certain Druid levels. For the rest of your career, you gain each of your subclass's features that are of your Druid level or lower.",
        ]);
        ArchetypeFeature::factory()->create([
        'archetype_id' => $druid->id,
        'level' => 4,
        'name' => "Ability Score Improvement",
        'description' => "You gain the Ability Score Improvement feat (see chapter 5) or another feat of your choice for which you qualify. You gain this feature again at Druid levels 8, 12, and 16.",
        ]);
        ArchetypeFeature::factory()->create([
        'archetype_id' => $druid->id,
        'level' => 5,
        ...
        **Primal Strike:** The extra damage of your Primal Strike increases to 2d8.",
        ...
        'level' => 19,
        'name' => "Epic Boon",
        'description' => "You gain an Epic Boon feat (see chapter 5) or another feat of your choice for which you qualify. Boon of Dimensional Travel is recommended.",
        ]);
        ArchetypeFeature::factory()->create([
        'archetype_id' => $druid->id,
        'level' => 20,
        ...
        **Step of the Wind.** You can take the Dash action as a Bonus Action. Alternatively, you can expend 1 Focus Point to take both the Disengage and Dash actions as a Bonus Action, and your jump distance is doubled for the turn.",
        ...
        'level' => 3,
        'name' => "Monk Subclass",
        'description' => "You gain a Monk subclass of your choice. The Warrior of Mercy, Warrior of Shadow, Warrior of the Elements, and Warrior of the Open Hand subclasses are detailed in the Monk Subclasses section.",
        ]);
        ArchetypeFeature::factory()->create([
        'archetype_id' => $monk->id,
        'level' => 4,
        ...
        **Step of the Wind.** When you expend a Focus Point to use Step of the Wind, you can choose a willing creature within 5 feet of yourself that is Large or smaller. You move the creature with you until the end of your turn. The creature's movement doesn't provoke Opportunity Attacks.",
        ...
        'level' => 1,
        'name' => "Spellcasting",
        'description' => "You have learned to channel the magical essence of nature to cast spells. See chapter 7 for the rules on spellcasting. The information below details how you use those rules with Ranger spells, which appear in the Ranger spell list later in the class's description.
        ...
        **Druidic Warrior.** You learn two Druid cantrips of your choice (see the Druid class's section for a list of Druid spells). Guidance and Starry Wisp are recommended. The chosen cantrips count as Ranger spells for you, and Wisdom is your spellcasting ability for them. Whenever you gain a Ranger level, you can replace one of these cantrips with another Druid cantrip.",
        ...
        'description' => "You gain a Ranger subclass of your choice. The Beast Master, Fey Wanderer, Gloom Stalker, and Hunter subclasses are detailed after this class's description. A subclass is a specialization that grants you features at certain Ranger levels. For the rest of your career, you gain each of your subclass's features that are of your Ranger level or lower.",
        ]);
        ArchetypeFeature::factory()->create([
        'archetype_id' => $ranger->id,
        'level' => 4,
        'name' => "Ability Score Improvement",
        'description' => "You gain the Ability Score Improvement feat (see chapter 5) or another feat of your choice for which you qualify. You gain this feature again at Ranger levels 8, 12, and 16.",
        ]);
        ArchetypeFeature::factory()->create([
        'archetype_id' => $ranger->id,
        'level' => 5,
        ...
        **Decrease Exhaustion.** Whenever you finish a Short Rest, your Exhaustion level, if any, decreases by 1.",
        ...
        'level' => 4,
        'name' => "Ability Score Improvement",
        'description' => "You gain the Ability Score Improvement feat (see chapter 5) or another feat of your choice for which you qualify. You gain this feature again at Rogue levels 8, 10, 12, and 16.",
        ]);
        ArchetypeFeature::factory()->create([
        'archetype_id' => $rogue->id,
        'level' => 5,
        ...
        **Obscure (Cost: 3d6).** The target must succeed on a Dexterity saving throw or it has the Blinded condition until the end of its next turn.",
        ...
        'level' => 19,
        'name' => "Epic Boon",
        'description' => "You gain an Epic Boon feat (see chapter 5) or another feat of your choice for which you qualify. Boon of the Night Spirit is recommended.",
        ]);
        ArchetypeFeature::factory()->create([
        'archetype_id' => $rogue->id,
        'level' => 20,
        ...
        'description' => "You have unearthed Eldritch Invocations, pieces of forbidden knowledge that imbue you with an abiding magical ability or other lessons. You gain one invocation of your choice, such as Pact of the Tome.
        ...
        **Replacing and Gaining Invocations.** Whenever you gain a Warlock level, you can replace one of your invocations with another one for which you qualify. You can't replace an invocation if it's a prerequisite for another invocation that you have.
        ...
        'level' => 1,
        'name' => "Pact Magic",
        'description' => "Through occult ceremony, you have formed a pact with a mysterious entity to gain magical powers. The entity is a voice in the shadows—its identity unclear—but its boon to you is concrete: the ability to cast spells. See chapter 7 for the rules on spellcasting. The information below details how you use those rules with Warlock spells, which appear in the Warlock spell list later in the class's description.
        ...
        **Spellcasting Focus.** You can use an Arcane Focus as a Spellcasting Focus for your Warlock spells.",
        ...
        'description' => "You gain a Warlock subclass of your choice. The Archfey Patron, Celestial Patron, Fiend Patron, and Great Old One Patron subclasses are detailed after this class's description. A subclass is a specialization that grants you features at certain Warlock levels. For the rest of your career, you gain each of your subclass's features that are of your Warlock level or lower.",
        ]);
        ArchetypeFeature::factory()->create([
        'archetype_id' => $warlock->id,
        'level' => 4,
        'name' => "Ability Score Improvement",
        'description' => "You gain the Ability Score Improvement feat (see chapter 5) or another feat of your choice for which you qualify. You gain this feature again at Warlock levels 8, 12, and 16.",
        ]);
        ArchetypeFeature::factory()->create([
        'archetype_id' => $warlock->id,
        'level' => 9,
        ...
        'level' => 1,
        'name' => "Spellcasting",
        'description' => "As a student of arcane magic, you have learned to cast spells. See chapter 7 for the rules on spellcasting. The information below details how you use those rules with Wizard spells, which appear in the Wizard spell list later in the class's description.
        ...
        **Spellcasting Focus.** You can use an Arcane Focus or your spellbook as a Spellcasting Focus for your Wizard spells.",
        ...
        'level' => 4,
        'name' => "Ability Score Improvement",
        'description' => "You gain the Ability Score Improvement feat (see chapter 5) or another feat of your choice for which you qualify. You gain this feature again at Wizard levels 8, 12, and 16.",
        ]);
        ArchetypeFeature::factory()->create([
        'archetype_id' => $wizard->id,
        'level' => 5,
        ...
        // Sorcerer
        //
        $sorcerer = Archetype::firstWhere('name', "Sorcerer");
        ArchetypeFeature::factory()->create([
            'archetype_id' => $sorcerer->id,
            'level' => 1,
            'name' => "Innate Sorcery",
            'description' => "An event in your past, or in the life of a parent or ancestor, left an indelible mark on you, infusing you with a simmering magic. This magic is a part of you, and as it matures, it comes to your control.

        As a Bonus Action, you can unleash the sorcerous power within you for 1 minute or until you dismiss it (no action required). During that time, you gain the following benefits:
        ...
        ArchetypeFeature::factory()->create([
            ...
            'level' => 1,
            'name' => "Spellcasting",
            'description' => "Drawing from your innate magic, you can cast spells. See chapter 7 for the rules on spellcasting. The information below details how you use those rules with Sorcerer spells, which appear in the Sorcerer spell list later in the class's description.
        ...
        **Prepared Spells of Level 1+.** You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose two level 1 Sorcerer spells. Burning Hands and Detect Magic are recommended.
        ...
        The number of spells on your list increases as you gain Sorcerer levels, as shown in the Prepared Spells column of the Sorcerer Features table. Whenever that number increases, choose additional Sorcerer spells until the number of spells on your list matches the number in the table. The chosen spells must be of a level for which you have spell slots. For example, if you're a level 3 Sorcerer, your list of prepared spells can include six Sorcerer spells of levels 1 and 2 in any combination.
        ...
        **Spellcasting Focus.** You can use an Arcane Focus as a Spellcasting Focus for your Sorcerer spells.",
        ...
        ArchetypeFeature::factory()->create([
            ...
            'level' => 2,
            'name' => "Font of Magic",
            'description' => "You tap into the deep wellspring of magic within yourself. This wellspring is represented by Sorcery Points, which allow you to create a variety of magical effects.

        **Sorcery Points.** You have 2 Sorcery Points, and you gain more as you reach higher levels, as shown in the Sorcery Points column of the Sorcerer Features table. You can never have more Sorcery Points than the number shown in the table for your level. You regain all expended Sorcery Points when you finish a Long Rest.

        **Converting Points to Spell Slots.** As a Bonus Action, you can expend some of your Sorcery Points to create one spell slot of the following levels:
        ...
        **Converting Slots to Points.** As a Bonus Action, you can expend one spell slot and gain a number of Sorcery Points equal to the slot's level.",
        ]);
        ArchetypeFeature::factory()->create([
            'archetype_id' => $sorcerer->id,
            'level' => 2,
            'name' => "Metamagic",
            'description' => "Because your magic flows from within, you can alter your spells to suit your needs; you gain two Metamagic options of your choice from the options below. You use the chosen options to temporarily modify spells you cast. To use an option, you must spend the number of Sorcery Points that it costs.

        You can use only one Metamagic option on a spell when you cast it, unless otherwise noted in one of those options.

        Whenever you gain a Sorcerer level, you can replace one of your Metamagic options with one you don't know. You gain two more options at Sorcerer level 10 and two more at Sorcerer level 17.

        **Careful Spell (Cost: 1 SP).** When you cast a spell that forces other creatures to make a saving throw, you can protect some of those creatures from the spell's full force. To do so, spend 1 Sorcery Point and choose a number of those creatures up to your Charisma modifier (minimum of one creature). A chosen creature automatically succeeds on its saving throw against the spell, and it takes no damage if it would normally take half damage on a successful save.

        **Distant Spell (Cost: 1 SP).** When you cast a spell that has a range of at least 5 feet, you change its range to 1 mile. Or when you cast a spell that has a range of Touch, you change its range to 30 feet.

        **Empowered Spell (Cost: 1 SP).** When you roll damage for a spell, you can spend 1 Sorcery Point to reroll a number of the damage dice up to your Charisma modifier (minimum of one), and you must use the new rolls. You can use Empowered Spell even if you've already used a different Metamagic option during the casting of the spell.

        **Extended Spell (Cost: 1 SP).** When you cast a spell that has a duration of 1 minute or longer, you can spend 1 Sorcery Point to double its duration, to a maximum duration of 24 hours. If the affected spell requires Concentration, you have Advantage on any saving throw you make to maintain that Concentration.

        **Heightened Spell (Cost: 2 SP).** When you cast a spell that forces a creature to make a saving throw to resist its effects, you can spend 2 Sorcery Points to give one target of the spell Disadvantage on its saving throws against the spell.

        **Quickened Spell (Cost: 2 SP).** When you cast a spell that has a casting time of an action, you can spend 2 Sorcery Points to change the casting time to a Bonus Action for this casting. You can't use this Metamagic if you've already taken a Bonus Action this turn.

        **Seeking Spell (Cost: 1 SP).** If you make an attack roll for a spell and miss, you can spend 1 Sorcery Point to reroll the d20, and you must use the new roll. You can use Seeking Spell even if you've already used a different Metamagic option during the casting of the spell.

        **Subtle Spell (Cost: 1 SP).** When you cast a spell, you can spend 1 Sorcery Point to cast it without any Verbal, Somatic, or Material components, except Material components that are consumed by the spell or that have a cost specified in the spell.

        **Transmuted Spell (Cost: 1 SP).** When you cast a spell that deals a type of damage from the following list, you can spend 1 Sorcery Point to change that damage type to one of the other listed types: Acid, Cold, Fire, Lightning, Poison, Thunder.

        **Twinned Spell (Cost: 1 SP).** When you cast a spell that can be cast with a higher-level spell slot to target an additional creature, you can spend 1 Sorcery Point to cast the spell at its lowest level and apply its single-target effects to two creatures within range. To be eligible, a spell must be incapable of targeting more than one creature at the spell's current level.",
        ]);
        ArchetypeFeature::factory()->create([
            'archetype_id' => $sorcerer->id,
            'level' => 3,
        ...
        ArchetypeFeature::factory()->create([
            ...
            'level' => 4,
            'name' => "Ability Score Improvement",
            'description' => "You gain the Ability Score Improvement feat (see chapter 5) or another feat of your choice for which you qualify. You gain this feature again at Sorcerer levels 8, 12, and 16.",
        ]);
        ArchetypeFeature::factory()->create([
            'archetype_id' => $sorcerer->id,
            'level' => 5,
